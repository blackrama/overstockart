$(document).ready(function() {
	$('.over-customer-rating-star-link').on('click',function(){
		$('.over-customer-form-wrapper').toggleClass('hide-element');
	})

	$('.over-view-min-item-wrapper').slick({
	  dots: false,
  speed: 300,
  slidesToShow: 4,
   ...
   slidesToScroll: 1
	...
	$('.over-view-min-item').on('click',function(){
		var $min_img = $(this).html();
		 $('.over-view-img-wrapper').html($min_img);
		
	});

$('.over-customer-rating-slider').slick({
	  dots: true,
...
$('.over-recomented-cotainer-slider').slick({
	  dots: true,
  speed: 300,
  slidesToShow: 4,
...
$("#oic1").on("click", ".over-info-container-menu-link", function(){
    $("#oic1 .over-info-container-menu-link").removeClass("oicm-link-active"); //удаляем класс во всех вкладках
    $(this).addClass("oicm-link-active"); //добавляем класс текущей (нажатой)

});
$("#oic2").on("click", ".over-info-container-menu-link", function(){
    $("#oic2 .over-info-container-menu-link").removeClass("oicm-link-active"); //удаляем класс во всех вкладках
    $(this).addClass("oicm-link-active"); //добавляем класс текущей (нажатой)

});

$('#ovic-description').on('click', function(){
	$('.ovic-description').removeClass('hide-element');
	$('.ovic-palette').addClass('hide-element');
	$('.ovic-shipment').addClass('hide-element');
});

$('#ovic-palette').on('click', function(){
	$('.ovic-description').addClass('hide-element');
	$('.ovic-palette').removeClass('hide-element');
	$('.ovic-shipment').addClass('hide-element');
});
$('#ovic-shipment').on('click', function(){
	$('.ovic-description').addClass('hide-element');
	$('.ovic-palette').addClass('hide-element');
	$('.ovic-shipment').removeClass('hide-element');
});
$('#oic-reviews').on('click', function(){
	$('.oic-reviews').removeClass('hide-element');
	$('.oic-faq').addClass('hide-element');
	
});
$('#oic-faq').on('click', function(){
	$('.oic-reviews').addClass('hide-element');
	$('.oic-faq').removeClass('hide-element');
